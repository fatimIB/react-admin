...
import DeleteConfirmationModal from "../ProductForms/DeleteModal.component"; // Import the delete confirmation modal
import "../../search.css";
import UpdateProductModal from "../ProductForms/UpdateModel.component";
...
const DataTable = () => {
  ...
  const handleDeleteConfirmation = async () => {
    try {
      ...
      // Delete the product
      await axios.delete(
        `http://127.0.0.1:8000/api/products/${deleteProductId}`,
        {
          headers: {
  ...
  return (
    <div
      style={{ marginLeft: "9%", paddingTop: "7%", height: 400, width: '55%' }}
    >
